...
setup(
    ...
    entry_points={
        "console_scripts": [
            ...
            "static_map_publisher = ats_mujoco_sim.static_map_publisher:main",
            ...
            "generate_rmuc_hfield = ats_mujoco_sim.rmuc_hfield:main",
            "generate_rmuc_wall_collisions = ats_mujoco_sim.rmuc_wall_collisions:main",
